...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { grade: @classroom.grade, size: @classroom.size, subject: @classroom.subject, timezone: @classroom.timezone }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { grade: @classroom.grade, size: @classroom.size, subject: @classroom.subject, timezone: @classroom.timezone }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
